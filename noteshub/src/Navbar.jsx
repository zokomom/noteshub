    ...
    return (
        ...
        <header className="bg-white text-black flex justify-around items-center p-2 w-full shadow-xl " >
            <div className="flex items-center">
                <div><img src={logo2} alt="Noteshub Logo" className='h-16' /></div>
            </div>
            <div className="mx-8"> 
                <input type="text" placeholder="🔍Search for notes..." className="w-lg p-2 border border-gray-400 rounded-full" />
            </div>
            <nav className="flex space-x-4">
                <div className=" p-2 rounded-md font-bold cursor-pointer underline">About</div> 
                <div className=" p-2 rounded-md font-bold cursor-pointer underline">Contact</div>
